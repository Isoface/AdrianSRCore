package es.outlook.adriansrj.core.util.tps;
...
/**
 * Useful class for getting the current tips per second of the running server.
 * <p>
 * @author AdrianSR / Saturday 18 April, 2020 / 12:14 AM
 */
