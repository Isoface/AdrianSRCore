 ...
 * <p>
 *
 * @author AdrianSR / Thursday 27 February, 2020 / 07:47 PM
 * @author badlogicgames@gmail.com, Xoppa
 */
public class BoundingBox {
	
	public static final BoundingBox ZERO     = new BoundingBox ( new Vector ( 0D , 0D , 0D ) ,
																 new Vector ( 0D , 0D , 0D ) );
	public static final BoundingBox BLOCK    = new BoundingBox ( new Vector ( 0D , 0D , 0D ) ,
																 new Vector ( 1D , 1D , 1D ) );
	...
	/**
	 * Constructs a new bounding box copying the values
	 * of the provided bounding box.
	 *
	 * @param copy the bounding box to copy.
	 */
	public BoundingBox ( BoundingBox copy ) {
		this.minimum    = copy.minimum.clone ( );
		this.maximum    = copy.maximum.clone ( );
		this.center     = copy.center.clone ( );
		this.dimensions = copy.dimensions.clone ( );
	}
	...
	public BoundingBox ( final Vector minimum , final Vector maximum ) {
		if ( Double.isInfinite ( minimum.getX ( ) ) && Double.isInfinite ( minimum.getY ( ) ) && Double.isInfinite (
				minimum.getZ ( ) ) &&
				Double.isInfinite ( maximum.getX ( ) ) && Double.isInfinite ( maximum.getY ( ) ) && Double.isInfinite (
				maximum.getZ ( ) ) ) {
