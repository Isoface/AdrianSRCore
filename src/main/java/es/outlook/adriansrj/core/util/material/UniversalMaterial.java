...
public enum UniversalMaterial implements Versionable {
    /*
    ...
    */
    ...
    ;
    private static final HashMap<String, UniversalMaterial > CACHED_UMATERIALS = new HashMap<>();
    ...
    public static UniversalMaterial match(String name, byte data) {
        ...
        for( UniversalMaterial umaterial : values()) {
        ...
        if(potion != null && potion.getItemMeta() instanceof PotionMeta) {
            ...
            if(customEffects.size() == 0) {
                ...
                if(type != null) {
                    ...
                    return UniversalMaterial.POTION;
                }
            }
        }
        return null;
    ...
    public static UniversalMaterial match(ItemStack item) {
        if(item != null) {
            ...
            if(EIGHT || NINE || TEN || ELEVEN || TWELVE) {
                final UniversalMaterial umaterial = UniversalMaterial.match( targetMaterial);
                if(umaterial == null) {
    ...
    private static UniversalMaterial tryMatchingCustom(ItemStack item, String targetMaterial) {
    ...
    public static UniversalMaterial getItem(Block block) {
        ...
        UniversalMaterial umaterial = null;
        if(!EIGHT && !NINE && !TEN && !ELEVEN && !TWELVE
            ...
            switch (data) {
                case 8: return UniversalMaterial.ACACIA_WOOD;
                case 12: return log2 ? UniversalMaterial.ACACIA_WOOD : UniversalMaterial.OAK_WOOD;
                case 13: return log2 ? UniversalMaterial.DARK_OAK_WOOD : UniversalMaterial.SPRUCE_WOOD;
                case 14: return UniversalMaterial.BIRCH_WOOD;
                case 15: return UniversalMaterial.JUNGLE_WOOD;
                default: break;
            }
            ...
            return material.contains("STICKY") ? UniversalMaterial.STICKY_PISTON : UniversalMaterial.PISTON;
    ...
    public static UniversalMaterial match(String name) {
        name = name.toUpperCase();
        try {
            final UniversalMaterial material = valueOf( name);
