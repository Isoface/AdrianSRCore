...
/**
 * Useful class for dealing with constructors.
 * <p>
 * @author AdrianSR / Sunday 12 April, 2020 / 04:32 PM
 */
public class ConstructorReflection {
	 ...
	 * @param parameter_types the parameter array.
	 * @return the {@code Constructor} object that matches the specified {@code parameter_types}.
	 ...
	 * @param declared        whether or not the constructor is declared.
	 * @param parameter_types the parameter array.
	 * @return the {@code Constructor} object that matches the specified
	...
	public static Constructor < ? > getAccessible ( Class < ? > clazz , boolean declared , Class < ? >... parameter_types )
			throws NoSuchMethodException, SecurityException {
		final Constructor < ? > constructor = get ( clazz , declared , parameter_types ); constructor.setAccessible ( true );
		return constructor;
	}
	 ...
	 * @param clazz           the class that holds the constructor.
	 * @param declared        whether or not the constructor is declared.
	 * @param parameter_types the parameters of the constructor, used for matching
	 *                        it.
