...
public class ClassReflection {
	...
	public static Class < ? > getSubClass ( Class < ? > root , String name ) throws ClassNotFoundException {
		try {
			...
			try { return getSubClass ( root , name , false ); } catch ( ClassNotFoundException ex_b ) {}
		}
		throw new ClassNotFoundException ( "the sub class " + name + " doesn't exist!" );
	}
	 ...
	 * @param package_name the name of the sub-package or null if the class is not
	 ...
	 * @param packageName the name of the desired package that contains the classes
