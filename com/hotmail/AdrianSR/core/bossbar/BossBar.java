...
public abstract class BossBar {
	 ...
	 */
	protected static final String VERSIONS_PACKAGE = "com.hotmail.adriansr.core.bossbar.version.";
	...
	public static BossBar createBossBar ( Player player , String title , double progress , BarColor color , BarStyle style ,
		...
		if ( Version.getServerVersion().isNewerEquals ( Version.v1_9_R1 ) ) {
			final BossBar bossbar = new com.hotmail.adriansr.core.bossbar.version.latest.BossBar ( title , progress , player );
