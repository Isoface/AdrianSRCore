...
public class MessagingUtils {
	 ...
	 */
	public static void sendPluginMessage(CustomPlugin plugin, Writable... arguments) throws IOException, IllegalAccessException,
	 ...
	 * @throws SecurityException
	 */
	public static void sendPluginMessage(CustomPlugin plugin, Written written) throws IOException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		/* donnot send empty arguments */
	 ...
	 * @throws IllegalAccessException
	 */
	public static void sendPluginMessage(CustomPlugin plugin, Player player, Writable... arguments)
	 ...
	 * @throws SecurityException
	 */
	public static void sendPluginMessage(CustomPlugin plugin, Player player, Written written)
			throws IOException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		/* donnot send empty arguments */
