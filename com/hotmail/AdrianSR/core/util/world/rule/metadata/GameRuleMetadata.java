package com.hotmail.AdrianSR.core.util.world.rule.metadata;
...
public class GameRuleMetadata extends FixedMetadataValue {
	...
	public GameRuleMetadata(Plugin owning_plugin, GameRuleType type, Object value) {
		super(owning_plugin, value); Validate.isTrue(type.isSameDataType(value));
		this.type = type;
	}
    ...
    protected void validateNumericValue() {
    	Validate.isTrue( ( getType().isNumericalValue() && value() instanceof Number ) , "This is not the type of value for this game rule!");
    }
    
    protected void validateBooleanValue() {
    	Validate.isTrue( ( getType().isBooleanValue() && value() instanceof Boolean ) , "This is not the type of value for this game rule!");
    }
}